...
struct Result FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t result_number1() const {
    return GetField<int32_t>(VT_RESULT_NUMBER1, 0);
  }
  int32_t result_number2() const {
    return GetField<int32_t>(VT_RESULT_NUMBER2, 0);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_RESULT_NUMBER1, 4) &&
           VerifyField<int32_t>(verifier, VT_RESULT_NUMBER2, 4) &&
           verifier.EndTable();
  }
};
...
struct ResultBuilder {
  ...
  void add_result_number1(int32_t result_number1) {
    fbb_.AddElement<int32_t>(Result::VT_RESULT_NUMBER1, result_number1, 0);
  }
  void add_result_number2(int32_t result_number2) {
    fbb_.AddElement<int32_t>(Result::VT_RESULT_NUMBER2, result_number2, 0);
  }
...
inline ::flatbuffers::Offset<Result> CreateResult(
    ...
    int32_t result_number1 = 0,
    int32_t result_number2 = 0) {
  ResultBuilder builder_(_fbb);
  builder_.add_result_number2(result_number2);
  builder_.add_result_number1(result_number1);
